...
public class StudentInfoAdapter extends RecyclerView.Adapter<EventsViewHolder> {
    ...
    public StudentInfoAdapter(Context context,List<EventsModel> eventsModelLists ){
    ...
    public EventsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.studentinfo_item_list, parent, false);
